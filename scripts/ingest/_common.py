...
SUBWAY_STATIONS: list[SubwayStation] = [
    ...
    SubwayStation("Bowling Green", ("4", "5"), 40.7048, -74.0138),
    SubwayStation("South Ferry", ("1",), 40.7016, -74.0132),
    SubwayStation("Wall St (4/5)", ("4", "5"), 40.7074, -74.0113),
    SubwayStation("World Trade Center", ("E",), 40.7127, -74.0134),
    SubwayStation("Chambers St", ("A", "C", "1", "2", "3"), 40.7158, -74.0091),
    SubwayStation("Spring St", ("6",), 40.7222, -73.9974),
    SubwayStation("Bleecker St", ("6",), 40.7259, -73.9947),
    SubwayStation("Astor Pl", ("6",), 40.7301, -73.9912),
    SubwayStation("1 Av (L)", ("L",), 40.7308, -73.9817),
    SubwayStation("3 Av (L)", ("L",), 40.7325, -73.9863),
    SubwayStation("23 St (1)", ("1",), 40.7440, -73.9959),
    SubwayStation("28 St (1)", ("1",), 40.7475, -73.9933),
    SubwayStation("34 St-Penn Station", ("1", "2", "3", "A", "C", "E"), 40.7505, -73.9934),
    SubwayStation("34 St-Herald Sq", ("B", "D", "F", "M", "N", "Q", "R", "W"), 40.7497, -73.9879),
    SubwayStation("42 St-Bryant Pk", ("B", "D", "F", "M"), 40.7536, -73.9832),
    SubwayStation("50 St (1)", ("1",), 40.7615, -73.9833),
    SubwayStation("59 St-Columbus Circle", ("A", "B", "C", "D", "1"), 40.7681, -73.9819),
    SubwayStation("66 St-Lincoln Ctr", ("1",), 40.7740, -73.9821),
    SubwayStation("72 St (1/2/3)", ("1", "2", "3"), 40.7787, -73.9819),
    SubwayStation("72 St (B/C)", ("B", "C"), 40.7755, -73.9762),
    SubwayStation("79 St (1)", ("1",), 40.7838, -73.9798),
    SubwayStation("86 St (1)", ("1",), 40.7886, -73.9760),
    SubwayStation("86 St (4/5/6)", ("4", "5", "6"), 40.7793, -73.9555),
    SubwayStation("96 St (1/2/3)", ("1", "2", "3"), 40.7940, -73.9720),
    SubwayStation("96 St (Q)", ("Q",), 40.7846, -73.9510),
    SubwayStation("103 St (6)", ("6",), 40.7905, -73.9474),
    SubwayStation("110 St (6)", ("6",), 40.7950, -73.9442),
    SubwayStation("116 St-Columbia", ("1",), 40.8079, -73.9645),
    SubwayStation("125 St (1)", ("1",), 40.8158, -73.9587),
    SubwayStation("125 St (4/5/6)", ("4", "5", "6"), 40.8045, -73.9374),
    SubwayStation("125 St (A/B/C/D)", ("A", "B", "C", "D"), 40.8112, -73.9534),
    SubwayStation("145 St (3)", ("3",), 40.8240, -73.9444),
    SubwayStation("Harlem-148 St", ("3",), 40.8280, -73.9398),
    SubwayStation("168 St", ("A", "C", "1"), 40.8407, -73.9398),
    # Brooklyn
    ...
    SubwayStation("Court St", ("R",), 40.6927, -73.9911),
    SubwayStation("Bergen St (F/G)", ("F", "G"), 40.6863, -73.9907),
    SubwayStation("Carroll St", ("F", "G"), 40.6802, -73.9956),
    SubwayStation("Smith-9 Sts", ("F", "G"), 40.6736, -73.9956),
    SubwayStation("4 Av-9 St", ("F", "G", "R"), 40.6701, -73.9892),
    SubwayStation("7 Av (F/G)", ("F", "G"), 40.6661, -73.9803),
    SubwayStation("15 St-Prospect Park", ("F", "G"), 40.6603, -73.9794),
    SubwayStation("Fort Hamilton Pkwy (F)", ("F", "G"), 40.6504, -73.9758),
    SubwayStation("Church Av (F/G)", ("F", "G"), 40.6442, -73.9794),
    SubwayStation("Bedford Av", ("L",), 40.7173, -73.9568),
    SubwayStation("Lorimer St (L/G)", ("L", "G"), 40.7140, -73.9505),
    SubwayStation("Graham Av", ("L",), 40.7148, -73.9442),
    SubwayStation("Grand St (L)", ("L",), 40.7117, -73.9405),
    SubwayStation("Montrose Av", ("L",), 40.7077, -73.9396),
    SubwayStation("Morgan Av", ("L",), 40.7062, -73.9332),
    SubwayStation("Jefferson St", ("L",), 40.7066, -73.9226),
    SubwayStation("DeKalb Av (L)", ("L",), 40.7038, -73.9182),
    SubwayStation("Bedford-Nostrand Avs", ("G",), 40.6898, -73.9532),
    SubwayStation("Classon Av", ("G",), 40.6889, -73.9595),
    SubwayStation("Clinton-Washington (G)", ("G",), 40.6884, -73.9667),
    SubwayStation("Fulton St (G)", ("G",), 40.6873, -73.9750),
    SubwayStation("Greenpoint Av", ("G",), 40.7314, -73.9544),
    SubwayStation("Nassau Av", ("G",), 40.7245, -73.9514),
    SubwayStation("DeKalb Av (B/D/N/Q/R)", ("B", "D", "N", "Q", "R"), 40.6904, -73.9818),
    SubwayStation("Prospect Park", ("B", "Q", "S"), 40.6618, -73.9620),
    SubwayStation("Parkside Av", ("Q",), 40.6552, -73.9610),
    SubwayStation("Church Av (B/Q)", ("B", "Q"), 40.6504, -73.9624),
    ...
    SubwayStation("Clark St", ("2", "3"), 40.6975, -73.9930),
    SubwayStation("Hoyt St", ("2", "3"), 40.6905, -73.9853),
    SubwayStation("Nevins St", ("2", "3", "4", "5"), 40.6883, -73.9803),
    SubwayStation("Grand Army Plaza", ("2", "3"), 40.6754, -73.9709),
    SubwayStation("Eastern Pkwy-Bklyn Museum", ("2", "3"), 40.6717, -73.9641),
    SubwayStation("Franklin Av (2/3/4/5)", ("2", "3", "4", "5"), 40.6707, -73.9580),
    SubwayStation("Bay Ridge-95 St", ("R",), 40.6166, -74.0306),
    SubwayStation("Bay Ridge Av", ("R",), 40.6347, -74.0234),
    SubwayStation("77 St (R)", ("R",), 40.6297, -74.0260),
    SubwayStation("86 St (R)", ("R",), 40.6225, -74.0287),
    SubwayStation("Sunset Park-25 St", ("R",), 40.6606, -73.9981),
    SubwayStation("36 St (D/N/R)", ("D", "N", "R"), 40.6553, -74.0036),
    SubwayStation("45 St (R)", ("R",), 40.6491, -74.0107),
    SubwayStation("53 St (R)", ("R",), 40.6450, -74.0144),
    SubwayStation("59 St (N/R)", ("N", "R"), 40.6411, -74.0177),
    SubwayStation("Avenue H (Q)", ("Q",), 40.6293, -73.9614),
    SubwayStation("Newkirk Plaza", ("B", "Q"), 40.6353, -73.9626),
    SubwayStation("Kings Hwy (B/Q)", ("B", "Q"), 40.6080, -73.9576),
    # Queens
    SubwayStation("Court Sq (E/M/7/G)", ("E", "M", "7", "G"), 40.7470, -73.9457),
    SubwayStation("21 St-Queensbridge", ("F",), 40.7541, -73.9425),
    SubwayStation("Queensboro Plaza", ("7", "N", "W"), 40.7508, -73.9402),
    SubwayStation("Vernon-Jackson", ("7",), 40.7424, -73.9536),
    SubwayStation("Hunters Point Av", ("7",), 40.7421, -73.9482),
    SubwayStation("Astoria Blvd", ("N", "W"), 40.7700, -73.9176),
    SubwayStation("Astoria-Ditmars Blvd", ("N", "W"), 40.7755, -73.9120),
    SubwayStation("30 Av (N/W)", ("N", "W"), 40.7669, -73.9216),
    SubwayStation("Broadway (N/W)", ("N", "W"), 40.7616, -73.9258),
    SubwayStation("36 Av (N/W)", ("N", "W"), 40.7566, -73.9298),
    SubwayStation("39 Av (N/W)", ("N", "W"), 40.7527, -73.9326),
    SubwayStation("Forest Hills-71 Av", ("E", "F", "M", "R"), 40.7215, -73.8444),
    SubwayStation("Kew Gardens-Union Tpk", ("E", "F"), 40.7144, -73.8311),
    SubwayStation("Flushing-Main St", ("7",), 40.7596, -73.8301),
    SubwayStation("Mets-Willets Point", ("7",), 40.7546, -73.8458),
    SubwayStation("82 St-Jackson Heights", ("7",), 40.7479, -73.8836),
    SubwayStation("90 St-Elmhurst Av", ("7",), 40.7484, -73.8761),
    SubwayStation("74 St-Broadway", ("7", "E", "F", "M", "R"), 40.7466, -73.8915),
    SubwayStation("Jamaica Center-Parsons/Archer", ("E", "J", "Z"), 40.7022, -73.8009),
    SubwayStation("Sutphin Blvd-Archer Av", ("E", "J", "Z"), 40.7003, -73.8077),
    # Bronx
    SubwayStation("Yankee Stadium-161 St", ("4", "B", "D"), 40.8276, -73.9259),
    SubwayStation("167 St (4)", ("4",), 40.8351, -73.9219),
    SubwayStation("167 St (B/D)", ("B", "D"), 40.8333, -73.9181),
    SubwayStation("170 St (4)", ("4",), 40.8398, -73.9176),
    SubwayStation("Burnside Av", ("4",), 40.8538, -73.9077),
    SubwayStation("Fordham Rd (B/D)", ("B", "D"), 40.8615, -73.8978),
    SubwayStation("Fordham Rd (4)", ("4",), 40.8617, -73.9009),
    SubwayStation("Pelham Bay Park", ("6",), 40.8527, -73.8281),
    SubwayStation("Tremont Av (B/D)", ("B", "D"), 40.8504, -73.9050),
    SubwayStation("Kingsbridge Rd (4)", ("4",), 40.8682, -73.8967),
    SubwayStation("Bedford Pk Blvd-Lehman", ("4",), 40.8732, -73.8906),
    SubwayStation("Norwood-205 St", ("D",), 40.8746, -73.8786),
    SubwayStation("Castle Hill Av", ("6",), 40.8344, -73.8511),
    SubwayStation("Parkchester", ("6",), 40.8330, -73.8602),
    # Staten Island Railway hub
    SubwayStation("St George (SIR)", ("SIR",), 40.6437, -74.0731),
    SubwayStation("Tompkinsville", ("SIR",), 40.6371, -74.0747),
    SubwayStation("Stapleton", ("SIR",), 40.6275, -74.0750),
]
